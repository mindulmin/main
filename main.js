...
const fallbackData = {
  i18n: {
    ko: {
      ...
      heroTitle: "틀린 문장을 고치는 순간, 실력이 오른다.",
      heroDesc: "퀴즈 → 팁 → 교정을 10분 안에 이어주는 학습 흐름.",
      heroCta: "바로 퀴즈로 실력 확인",
      heroCtaAlt: "실전 팁 바로 보기",
      statLanguages: "2개 언어 지원",
      statModules: "3단계 학습 구조",
      statStage: "MVP 버전",
      ...
      copyButton: "표현 복사",
      quizTitle: "단어 퀴즈",
      quizDesc: "실전에서 자주 틀리는 문장만 모았습니다.",
      quizLang: "학습 언어",
      quizLevel: "난이도",
      levelEasy: "쉬움",
      levelMid: "보통",
      ...
      whyKoreanTitle: "영어·한국어 양방향 학습 플랫폼",
      whyKoreanDesc: "영어 학습자뿐 아니라 한국어 학습자까지 한 흐름으로 설계했습니다.",
    ...
    en: {
      ...
      heroTitle: "Fix a sentence, level up fast.",
      heroDesc: "A 10-minute flow that connects quiz, tips, and correction.",
      heroCta: "Check your level with a quiz",
      heroCtaAlt: "See practical tips",
      statLanguages: "2 languages supported",
      statModules: "3-step learning flow",
      statStage: "MVP release",
      ...
      quizTitle: "Word Quiz",
      quizDesc: "Only real-world sentences people get wrong often.",
      ...
      tipsTitle: "Search-first Learning Tips",
      ...
      whyKoreanTitle: "Two-way learning for English and Korean",
      whyKoreanDesc: "We serve both English learners and Korean learners in a single flow.",
  ...
  tips: [
    {
      id: "tip-1",
      lang: "ko",
      title: "영어 관사 a/the 완벽 구분법",
      tags: ["문법", "롱테일"],
      body: "a/an은 처음 등장, the는 이미 공유된 대상을 지칭합니다. 짧은 예문 6개로 감각을 고정하세요."
    },
    {
      id: "tip-2",
      lang: "ko",
      title: "은/는 이/가 차이 쉽게 이해하기",
      tags: ["문법", "기초"],
      body: "화제는 은/는, 정보는 이/가로 구분합니다. 대조 문장 3세트로 빠르게 체감하세요."
    },
    {
      id: "tip-3",
      lang: "ko",
      title: "비즈니스 영어 이메일 시작 문장 10개",
      tags: ["비즈니스", "표현"],
      body: "문의, 회신, 일정 조율로 나누어 시작 문장을 템플릿처럼 사용해 보세요."
    },
    {
      id: "tip-4",
      lang: "en",
      title: "Shadowing routine for speaking fluency",
      tags: ["speaking", "routine"],
      body: "Pick a 60-second clip, shadow it 3 times, then record yourself once. Track improvements weekly."
    },
    {
      id: "tip-5",
      lang: "en",
      title: "Korean honorifics in 3 scenarios",
      tags: ["Korean", "honorifics"],
      body: "Split usage into elders, colleagues, and service contexts. Practice switching between -습니다 and -요 forms."
    }
  ]
};
